...
const HalamanGuru = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Login attempt:', { nip, password, rememberMe });
  };
  ...
  return (
    ...
    >
      ...
      <header className='flex justify-between items-center p-4'>
        <div className='text-gray-500'>Halaman Guru</div>
      ...
      <div className='flex flex-col items-center justify-center px-4 py-8'>
        ...
        <div className='text-center mb-12'>
          <h1 className='text-4xl font-bold mb-2'>
            <span className='text-primary-600'>SISTEM INFORMASI</span>
          </h1>
        ...
        >
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button
              type='submit'
              className='w-full bg-primary-600 hover:bg-primary-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 transform hover:scale-105 active:scale-95'
            >
              Masuk
            </button>
          </form>
        ...
        >
          <p className='mb-1'>
            ✓ Portal khusus guru untuk mengelola pengaduan dan memberikan
            respon. Keamanan data terjamin.
          </p>
        </div>
