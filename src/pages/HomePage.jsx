				...
				<div className="col-lg-8 text-start">
					...
					<div className="alert alert-info border-0 bg-light-subtle">
						...
						<p
							...
							kenyamanan seluruh siswa, guru, serta staf. Jika Anda melihat atau
							mengalami hal yang tidak pantas seperti bullying, pelecehan, atau
							pelanggaran lainnya, Anda dapat melaporkannya melalui saluran ini
							tanpa mengungkap identitas. Semua laporan akan diproses secara
					...
					<div className="card border-0 bg-body-secondary mt-4">
						<div className="card-body p-4">
							...
							<ul className="list-unstyled">
								<li className="mb-3 fs-6 d-flex align-items-center gap-3">
									...
									<span
										...
										Sampaikan secara rinci—ceritakan kejadian, waktu, dan pihak
										yang terlibat
									</span>
								</li>
								<li className="mb-3 fs-6 d-flex align-items-center gap-3">
							...
							<p
								...
								melihat perkembangan laporan dan memberikan informasi tambahan.
							</p>
						</div>
					</div>
