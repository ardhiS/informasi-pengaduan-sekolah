...
export default function AdminComplaintsPage() {
  ...
  const fetchAllComplaints = useCallback(async () => {
    ...
    try {
      ...
      const [inProgressRes, resolvedRes, rejectedRes] = await Promise.all([
        //KALAU SUDAH AKTIFKAN KODE INI api.getComplaints({ status: "pending" }),
      ...
      setComplaints({
        //TAMBAHKAN JADI pending: pendingRes.data.complaints || []
        pending: [],
